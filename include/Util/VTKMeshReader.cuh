#ifndef RENDEREROPTIX_VTKMESHREADER_CUH
#define RENDEREROPTIX_VTKMESHREADER_CUH
...
namespace project {
    ...
    public:
        ...
        static std::vector<RendererMeshParticle> readVTKDataCache(const std::string & cacheFilePathName);
        static void freeVTKData(std::vector<RendererMeshParticle> & particles);
...
#endif //RENDEREROPTIX_VTKMESHREADER_CUH
